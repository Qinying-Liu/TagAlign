...
class TCL(nn.Module):
    def __init__(
        ...
        self.label_embedding = nn.Parameter(torch.load(f'../data/CC12M/CC12M-RAM-tags/label_embedding_BASE+BLIP+RAM_10000.pth', map_location='cpu').float(), requires_grad=False)
