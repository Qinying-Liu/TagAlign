...
class ImageNetSDataset(CustomDataset):
    ...
    fixed to '.png'.
    """
    CLASSES50 = ('background', 'goldfish', 'tiger shark', 'goldfinch', 'tree frog',
    ...
    CLASSES300 = (
        'background', 'tench', 'goldfish', 'tiger shark', 'hammerhead',
    ...
    CLASSES919 = (
        'background', 'house finch', 'stupa', 'agaric', 'hen-of-the-woods',
