...
> Qinying Liu*, Wei Wu*, Kecheng Zheng†, Zhan Tong, Jiawei Liu, Yu Liu, Wei Chen, Zilei Wang†, Yujun Shen(*equal contribution, †corresponding author)<br>
...
## 💡 Highlights
- 🔥 **5.2%** mIOU improvement on a broad suite of semantic segmentation datasets (VOC: PASCAL VOC, Context: PASCAL Context, Object: COCO-Object, IN: ImageNet-S, Stuff: COCO-Stuff, City: Cityscapes, ADE: ADE20K).
...
@article{liu2023tagalign,
  ...
  author={Liu, Qinying and Wei, Wu and Zheng, Kecheng and Tong, Zhan and Liu, Jiawei and Liu, Yu and Chen, Wei and Wang, Zilei and Shen, Yujun},
