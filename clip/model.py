...
class Transformer(nn.Module):
    ...
    # def forward(self, x: torch.Tensor, ignore_last_attn=False):
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, spatial=True, ignore_last_attn=False):
        ...
        x = self.transformer(x, ignore_last_attn)
